...
urlpatterns = [
    ...
    path('factures/<uuid:facture_id>/modifier/', views.recreer_facture, name='facture-update'),
    ...
    path('factures/<uuid:facture_id>/telecharger/', views.telecharger_facture_pdf, name='telecharger-facture'),
